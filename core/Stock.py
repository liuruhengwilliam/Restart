...
def stock_main():
    ...
    PeriodfuncHook = (coordinate.work_operation,coordinate.work_storage)#增加存档线程20180607
    funcList = (HBfuncHook + PeriodfuncHook) # 回调函数列表

    TimerMotor.start_loop_timer(funcList,[int(period),Constant.UPDATE_BASE_PERIOD,Constant.UPDATE_BASE_PERIOD])
